...
### Programowość Włoska i Niemiecka

## Figury Podstawowe

Estetyka naśladownictwa i afektów, nośniki różnych znaczeń pozamuzycznych.

### Typu _Hypotyposis_ (Naśladowcze)

Zjawiska pozamuzyczne, zwłaszcza dźwiękowe.

|   |   |
|---|---|
|_Assimilatio_|Upodobnienie zjawisk, muzycznych do kształtów, np. łukowa melodia: symbol tęczy. Śpiew ptaków, naśladowanie dźwięków burzy, drżenia ziemi, instrumentów muzycznych. Onomatopeje.|
|_Anabasis (ascensus)_|Kierunek wznoszący się melodii. Występuje podczas wywyższania, scen wzniosłych, niebo. _Et ascendit, et exutavit._|
|_Katabasis (descensus)_|Kierunek opadający melodii. Upadek, zstępowanie, poniżenie, strącenie, uległość, służalczość. _Descendit de celis. Deposuit potentes._|
|_Kyklosis (circulatio)_|Stan pośredni pomiędzy _**Anabasis**_ i _**Katabasis**_. Ruch okrężny, wahanie się, błądzenie, kręcenie się w kółko. _We have turned, ev’ry one to his own way._|
|_Fuga (alio nempe sensu)_|Nie ścisła forma polifoniczna, ale szybki biegnik na słowach bieg, ucieczka. _Fugit_ z łaciny oznacza ucieka.|
|_Tirata_|Gwałtowny ruch w jednym kierunku. Szybki przebieg dźwiękowy z góry w dół lub odwrotnie: rzucać, miotać, rozdzierać, atakować, uderzać, nacierać.|
|_Tenuta_|Długa nuta. Oznaczała trwanie w bezruchu, sen, równinę, pasywność.|

### Typu Emphasis (Emfatyczne)

Podkreślają silne emocje, afekty.

|   |   |
|---|---|
|_Emphasis_|Inaczej _**accento**_. Silne podkreślenie sensu wypowiedzi za pomocą różnych środków, np. faktury.|
|_Epizeuxis (subjuncito)_|Łączenie, dołączenie. Kilkakrotnie powtórzenie motywu muzycznego w tym samym głosie na różnych stopniach skali i w różnych kierunkach ruchu.|
|_Pathopoja_|Budząca patos. Podwyższenie ekspresji muzycznej przez zastosowanie odcinka następujących półtonów, w późnym baroku często umieszczany w basie. Ból, Cierpienie, rozpacz, silne namiętności.|
|_Exclamatio (ecphonesis)_|Fraza, zdanie wykrzyknikowe. Skok o sekstę małą w góre lub inny interwał o dużej rozpiętości (większy niż tercja) w jakimkolwiek kierunku.  <br>Trzy główne zastosowania:  <br>1. Euforyczna radość  <br>2. Błaganie, Prośba  <br>3. Wybuch gniewu, rozpaczy, trwogi|
|_Dubitatio_|Powątpiewanie. Zaskakująca modulacja (zmiana tonacji), lub seria zatrzymań ruchu poprzez fermaty na wybranych dźwiękach. Utwór zdaje się snuć bez końca, trudno przewidzieć kadencje.|
|_Interegatio_|Interwał wznoszący, naśladujący zapytanie na zasadzie intonacji. Czasem kadencja frygijska.|
|_Cadentia Duriuscula_|Kadencja twarda, nieprzyjemna. Obrazuje ból, cierpienie, grzech, zło.|
|_Saltus Duriusculus_|Nieprzyjemny skok, zazwyczaj o interwał zakazany (np. kwinta zmniejszona, septyma wielka). Znaczenie podobne jak _Cadentia Duriscula_.|
|_Passus Duriusculus_|Figura zakłócająca naturalną diatoniczność systemu. Chromatyczny pasaż złożony z samych półtonów albo swobodne zakłócenie porządku diatonicznego przez różne interwały, aż do trytonu. Smutek żałość, ból, fałsz, kłamstwo. Często w związku z muzycznym symbolem krzyża (_imaginatio crucis_)|
|_Catachresis (abusio)_|Nadużycie. Ma dwa znaczenia:  <br>1. Starsze - Faburden - następstwo równolegle prowadzonych akordów seksowych lub kwartsekstowych o surowym brzmieniu.  <br>2. Nowsze - _Syncopatia_, _catachrestica_ - źle rozwiązany dysonans, zwłaszcza synkopowany, powodujący fałszywe brzmienie.|
|_Parrhesia_|Swoboda w sposobie mówienia. Dysonans wpleciony nieoczekiwanie pomiędzy konsonanse, jakikolwiek swobodnie zastosowany dysonans lub _**Relatio falsa**_ tzw. _**mi contra fa,**_ czyli ukośne brzmienie półtonu|
|_Aposiopesis_|Zamilknięcie, przerwanie wypowiedzi, niedopowiedzenie. Cisza, milczenie wyrażona w pauzie generalnej, wyrażająca śmierć, pustkę po stracie kogoś bliskiego.|
|_Abruptio (tmesis)_|Nagłe przerwanie, wątku na pauzie na skutek oburzenia, grozy, przestrachu, gniewu, wzruszenia.|
|_Suspiranto_|Łkanie, westchnienie. Łagodne, częste, przerywanie melodii pauzami, z podziałem słów na sylabach.|
|_Noema_|Zdanie dające do myślenia. Nagromadzenie czystych konsonansów, najczęściej w motetach. Deklamacyjne, akordowe przedstawienie takstu, jako kontrast do faktury polifonicznej|
|_Mutatui (Antitheton)_|Kontras. Można mówić o pięciu jego rodzajach:  <br>1. _**per motus**_ - agogiczny  <br>2. _**per tonos**_ - kontrast trybu dur-moll  <br>3. _**per genus**_ - kontrast diatoniki i chromatyki  <br>4. _**per systema**_ - kontrast rejestru  <br>5. _**per melopoetiam**_ - kontrast w budowie melodii na zasadzie stosowania  <br>różnych jej typów  <br>Maniera:  <br>- _**Distendente**_ (męska, mocna, oparta o interwały dużych rozmiarów)  <br>- _**Restrigente**_ (żeńska, omdlewająca i delikatna, interwały małych rozmiarów)  <br>- _**Quieta**_ (melodia pośrednia pomiędzy męską i żeńską)|

### Figury uzupełniające (Graniczne)
